...
const approvingDelegateAuthority = async () => {
  // ----------------------------------------------------
  //  Setup
  // ----------------------------------------------------
  dotenv.config();
  ...
  const newDelegate = publicKey('55AfqEL3TC9mpkDZ63UCgDrzPcMQd5aZtDegfQCWQ5tK');
...
approvingDelegateAuthority();

/*
ts-node src/approvingDelegateAuthority.ts
...
leafOwner => HXtBm8XZbxaTt41uqaKhwUAa6Z1aPyvJdsZVENiWsetg
newDelegate => 55AfqEL3TC9mpkDZ63UCgDrzPcMQd5aZtDegfQCWQ5tK
signature => 4iwro34He3zgcn1zARxZaXvvmnJJLUWp6GMcJZMuAwrQFKhEgQTQpodY17UGUELPERXHW7pPG5LtJ79tXw7R35iU
